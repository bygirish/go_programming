...
func main() {
	...
	// %b -> base 2
	// %x -> base 16
	fmt.Printf("255 in base 2 is %b\n", 1055)   //  => 55 in base 2 is 110111
	fmt.Printf("255 in base 2 is %04b\n", 1055) //  => 55 in base 2 with this is 00110111 (if we want to print the number in 8 bits, whereas if bits are less then 8 then leading zeros should be inlcuded)
